                  ...
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <label class="form-control-label">Select Date<span class="text-danger ml-2">*</span></label>
                            <input type="date" class="form-control" name="dateTaken" id="exampleInputFirstName" placeholder="Section">
                        </div>
                        <!-- <div class="col-xl-6">
                        <label class="form-control-label">Class Arm Name<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="classArmName" value="<?php echo $row['section'];?>" id="exampleInputFirstName" placeholder="Class Arm Name">
                        </div> -->
                    </div>
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                      ...
                      tblsection.section,tblyaer.year,tblyear.semId,tblsem.semName,
