      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Class Teacher Dashboard (<?php echo $rrw['className'].' - '.$rrw['section'];?>)</h1>
            <ol class="breadcrumb">
          ...
          <?php 
$query1=mysqli_query($conn,"SELECT * from tblstudents where classId = '$_SESSION[classId]' and sectionId = '$_SESSION[sectionId]'");                       
...
?>
            ...
            <!-- Earnings (Annual) Card Example -->
             <?php 
$query1=mysqli_query($conn,"SELECT * from tblsection");                       
...
?>
            ...
            <?php 
$query1=mysqli_query($conn,"SELECT * from tblattendance where classId = '$_SESSION[classId]' and sectionId = '$_SESSION[sectionId]'");                       
