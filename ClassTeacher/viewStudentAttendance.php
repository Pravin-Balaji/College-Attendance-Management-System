                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <?php
                        $qry= "SELECT * FROM tblstudents where classId = '$_SESSION[classId]' and sectionId = '$_SESSION[sectionId]' ORDER BY firstName ASC";
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "1"){ //All Attendance
                        ...
                        INNER JOIN tblsection ON tblsection.Id = tblattendance.sectionId
                        INNER JOIN tblyear ON tblyear.Id = tblattendance.yearId
                        INNER JOIN tblsem ON tblsem.Id = tblyear.semId
                        INNER JOIN tblstudents ON tblstudents.admissionNumber = tblattendance.admissionNo
                        where tblattendance.admissionNo = '$admissionNumber' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.sectionId = '$_SESSION[sectionId]'";
                       ...
                       if($type == "2"){ //Single Date Attendance
                        ...
                        INNER JOIN tblsem ON tblsem.Id = tblyear.semId
                        INNER JOIN tblstudents ON tblstudents.admissionNumber = tblattendance.admissionNo
                        where tblattendance.dateTimeTaken = '$singleDate' and tblattendance.admissionNo = '$admissionNumber' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.sectionId = '$_SESSION[sectionId]'";
                       ...
                       if($type == "3"){ //Date Range Attendance
                        ...
                        INNER JOIN tblsem ON tblsem.Id = tblyear.semId
                        INNER JOIN tblstudents ON tblstudents.admissionNumber = tblattendance.admissionNo
                        where tblattendance.dateTimeTaken between '$fromDate' and '$toDate' and tblattendance.admissionNo = '$admissionNumber' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.sectionId = '$_SESSION[sectionId]'";
