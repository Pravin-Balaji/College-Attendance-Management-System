...
if(isset($_POST['save'])){
  ...
  $yearId = $_POST['yearId'];
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>This Person Already Exists!</div>";
    }
    else{

    $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,otherName,admissionNumber,password,classId,sectionId,dateCreated,yearId) 
    value('$firstName','$lastName','$otherName','$admissionNumber','12345','$classId','$sectionId','$dateCreated','$yearId')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    otherName='$otherName', admissionNumber='$admissionNumber',password='12345', classId='$classId',sectionId='$sectionId',yearId='$yearId'
    where Id='$Id'");
            if ($query) {
            ...
            <div class="col-lg-12">
                   ...
                   <div class="form-group row mb-3">
                    ...
                    <div class="col-xl-6">
                        <label class="form-control-label">Select Year<span class="text-danger ml-2">*</span></label>
                         <?php
                        $qry= "SELECT * FROM tblyear ORDER BY yearName ASC";
                        ...
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="classId" onchange="sectionDropdown(this.value)" class="form-control mb-3">';
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT tblstudents.Id,tblclass.className,tblsection.section,tblsection.Id AS sectionId,tblstudents.firstName,
                      tblstudents.lastName,tblstudents.otherName,tblstudents.admissionNumber,tblstudents.dateCreated,tblyear.yearName
                      FROM tblstudents
