...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"INSERT into tblclassteacher(firstName,lastName,emailAddress,password,phoneNo,classId,sectionId,dateCreated) 
    value('$firstName','$lastName','$emailAddress','$sampPass_2','$phoneNo','$classId','$sectionId','$dateCreated')");

    if ($query) {
        
        $qu=mysqli_query($conn,"update tblsection set isAssigned='1' where Id ='$sectionId'");
            if ($qu) {
...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
    ...
    emailAddress='$emailAddress', password='$password',phoneNo='$phoneNo', classId='$classId',sectionId='$sectionId'
    where Id='$Id'");
            if ($query) {
...
//--------------------------------DELETE------------------------------------------------------------------
  ...
  if (isset($_GET['Id']) && isset($_GET['sectionId']) && isset($_GET['action']) && $_GET['action'] == "delete")
	{
        $Id= $_GET['Id'];
        ...
        if ($query == TRUE) {
            ...
            $qu=mysqli_query($conn,"update tblsection set isAssigned='0' where Id ='$sectionId'");
            if ($qu) {
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT tblclassteacher.Id,tblclass.className,tblsection.section,tblsection.Id AS sectionId,tblclassteacher.firstName,
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><a href='?action=delete&Id=".$rows['Id']."&sectionId=".$rows['sectionId']."'><i class='fas fa-fw fa-trash'></i></a></td>
                              </tr>";
                          }
                      }
                      else
